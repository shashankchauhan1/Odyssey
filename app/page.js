      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-16">
        ...
        <div className="mt-12 sm:mt-16">
          ...
          {loading ? (
            ...
            <div className="mt-8 rounded-[24px] border-2 border-dashed border-slate-200 bg-slate-50/50 p-12 text-center">
              <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">
                ✈️
              </div>
              <p className="text-base font-bold text-slate-900">No trips planned yet</p>
              <p className="mt-1 text-sm text-slate-500 mb-6 max-w-xs mx-auto">Start your next adventure by searching for a destination above.</p>
              <SignedIn>
                <button
              ...
              <SignedOut>
                <p className="text-xs text-slate-400">Sign in to get started.</p>
              </SignedOut>
            </div>
          )}
        </div>
