...
export async function generateDestinationProfile(name) {
  ...
  const prompt = `
    ...
    Required Structure:
      ...
      "best_time": "Best months to visit name",
      "best_time_description": "Detailed explanation of why this is the best time (weather, crowds)",
      "currency": "Local currency code and name",
      "language": "Primary language(s)",
      "timezone": "Timezone name/offset",
      "cultural_highlights": ["3-4 bullet points on culture"],
      "famous_places": ["3-4 top landmarks"],
      "local_food": ["3-4 must-try dishes"],
      "safety_tips": ["2-3 safety precautions"],
      "travel_tips": ["2-3 general travel tips (tipping, dress code, etc)"],
      "smart_tips": ["3-4 specific, actionable tips (e.g., 'Visit X at sunrise', 'Book tickets for Y in advance', 'Best spot for sunset is Z')"],
      "attractions": [
      ...
      "transport_info": {
        "flight": { "available": true, "details": "Nearest airport is X, 20km away", "price_range": "$100-200", "duration": "2h from Capital", "nearest_airport": "Airport Name" },
        "train": { "available": true, "details": "Direct train available", "price_range": "$20-50", "duration": "5h", "nearest_station": "Station Name" },
        "bus": { "available": true, "details": "Overnight buses available", "price_range": "$10-30", "duration": "8h" },
        "car": { "available": true, "details": "Good highway connectivity via NH-44", "price_range": "$100 fuel", "duration": "6h" }
      },
      "connectivity": {
        "sim": "SIM/eSIM advice",
        "wifi": "Wi‑Fi notes"
      ...
      "emergency": {
        "note": "Emergency note",
        "number": "Primary emergency number"
      },
      "essential_phrases": [
