...
export function defaultDestinationProfile(name) {
  return {
    ...
    transport_info: {
      flight: { available: false, details: 'Check nearest airport.', price_range: '', duration: '', nearest_airport: '' },
      train: { available: false, details: 'Check nearest railway station.', price_range: '', duration: '', nearest_station: '' },
      bus: { available: false, details: 'Check local bus schedules.', price_range: '', duration: '' },
      car: { available: false, details: 'Check driving route.', price_range: '', duration: '' }
    },
...
export function destinationNeedsEnrichment(dest) {
  ...
  return !(
    ...
    hasLocalRules &&
    Array.isArray(d.cultural_highlights) && d.cultural_highlights.length > 0 &&
    d.transport_info && typeof d.transport_info === 'object' && d.transport_info.flight
  );
